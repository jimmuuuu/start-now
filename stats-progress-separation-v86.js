...
(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      .sn86-purpose{margin:-5px 0 18px;color:var(--muted);font-size:var(--text-sm);line-height:1.5;max-width:430px}
      ...
      .sn86-range button{border:0;background:transparent;color:var(--muted);font-weight:800;font-size:var(--text-xs);padding:8px 11px;border-radius:10px}
      ...
      .sn86-change-card{padding:15px;min-height:118px}.sn86-change-card>span:first-child{display:block;font-size:var(--text-xs);font-weight:900;letter-spacing:.07em;text-transform:uppercase;color:var(--muted)}
      .sn86-change-card strong{display:block;font-size:27px;line-height:1.05;margin:10px 0 8px;letter-spacing:-.7px}.sn86-change-card strong small{font-size:var(--text-sm);color:var(--muted);letter-spacing:0}
      .sn86-delta{display:inline-flex;align-items:center;width:max-content;border-radius:999px;padding:5px 8px;font-size:var(--text-xs);font-weight:900}.sn86-delta.up{background:#EEF8DD;color:#628C15}.sn86-delta.down{background:#FFF0F0;color:#C94B50}.sn86-delta.neutral{background:#F0F1F2;color:#747980}
      .sn86-comparison-note{font-size:var(--text-xs);color:var(--muted);margin:0 0 12px}
      .sn86-trend-card{padding:17px;margin-top:14px}.sn86-trend-head{display:flex;justify-content:space-between;gap:10px;align-items:flex-start}.sn86-trend-head h2{font-size:var(--text-lg);margin:3px 0 0}.sn86-trend-head span{font-size:var(--text-xs);color:var(--muted);font-weight:700}
      ...
      .sn86-bar-wrap{height:132px;display:grid;grid-template-rows:1fr auto;gap:7px;align-items:end;justify-items:center;min-width:34px}.sn86-bar-track{width:100%;max-width:36px;height:104px;border-radius:10px;background:#F0F1ED;display:flex;align-items:flex-end;overflow:hidden}.sn86-bar-fill{width:100%;min-height:6px;border-radius:9px 9px 0 0;background:linear-gradient(180deg,#78A9FF,#3B82F6)}.sn86-bar-fill.coral{background:linear-gradient(180deg,#FF8A8D,var(--coral))}.sn86-bar-wrap small{font-size:var(--text-xs);color:var(--muted);font-weight:700}
      .sn86-change-list{display:grid;margin-top:12px}.sn86-change-row{display:grid;grid-template-columns:1fr auto;gap:12px;align-items:center;padding:11px 0;border-top:1px solid var(--line)}.sn86-change-row:first-child{border-top:0}.sn86-change-row strong{display:block;font-size:var(--text-sm)}.sn86-change-row small{display:block;margin-top:3px;font-size:var(--text-xs);color:var(--muted)}
      .sn86-baseline{margin-top:14px;padding:13px 14px;border-radius:14px;background:#F4F7FB;color:#546171;font-size:var(--text-sm);line-height:1.5}
      .sn86-lifetime-banner{padding:15px 16px;border:1px solid var(--line);border-radius:16px;background:var(--surface);margin:-3px 0 14px}.sn86-lifetime-banner strong{display:block;font-size:var(--text-sm)}.sn86-lifetime-banner span{display:block;color:var(--muted);font-size:var(--text-xs);margin-top:4px;line-height:1.45}
      .sn86-stat-grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}.sn86-stat-card{padding:15px;min-height:108px}.sn86-stat-card span{display:block;font-size:var(--text-xs);font-weight:900;letter-spacing:.07em;text-transform:uppercase;color:var(--muted)}.sn86-stat-card strong{display:block;font-size:26px;line-height:1.05;margin:9px 0 5px}.sn86-stat-card small{display:block;color:var(--muted);font-size:var(--text-xs)}
      .sn86-section{padding:16px;margin-top:12px}.sn86-section h2{font-size:var(--text-lg);margin:0 0 12px}.sn86-record-row{display:grid;grid-template-columns:1fr auto;gap:12px;align-items:center;padding:10px 0;border-top:1px solid var(--line)}.sn86-record-row:first-of-type{border-top:0}.sn86-record-row strong,.sn86-record-row small{display:block}.sn86-record-row strong{font-size:var(--text-sm)}.sn86-record-row small{font-size:var(--text-xs);color:var(--muted);margin-top:3px}.sn86-record-row b{font-size:var(--text-sm)}
      .sn86-average-grid{display:grid;grid-template-columns:repeat(3,1fr);gap:8px}.sn86-average{padding:11px;border:1px solid var(--line);border-radius:13px;text-align:center;background:var(--surface)}.sn86-average strong{display:block;font-size:var(--text-lg)}.sn86-average span{display:block;margin-top:4px;font-size:var(--text-xs);color:var(--muted)}
      .sn86-grade-dist{display:grid;grid-template-columns:repeat(5,1fr);gap:6px}.sn86-grade-box{border:1px solid var(--line);border-radius:12px;padding:10px 5px;text-align:center}.sn86-grade-box strong{display:block;font-size:var(--text-lg)}.sn86-grade-box span{font-size:var(--text-xs);color:var(--muted)}
      .sn86-empty{padding:20px 10px;text-align:center;color:var(--muted);font-size:var(--text-xs)}
