...
(() => {
  ...
  function installStyles() {
    ...
    style.textContent = `
      ...
      .sn66-modes{display:grid;grid-template-columns:repeat(3,1fr);gap:10px;margin-bottom:16px}.sn66-mode{border:1px solid var(--line);background:var(--surface);border-radius:18px;padding:16px;text-align:left;color:var(--text);cursor:pointer;min-height:138px;transition:transform .15s ease,border-color .15s ease,background .15s ease}.sn66-mode:hover{transform:translateY(-1px)}.sn66-mode.active{border-color:#BFD6FF;background:#F7FAFF}.sn66-mode-icon{width:42px;height:42px;border-radius:13px;background:#EEF4FF;color:#2F6DF6;display:grid;place-items:center;margin-bottom:14px}.sn66-mode strong,.sn66-mode span{display:block}.sn66-mode strong{font-size:var(--text-base)}.sn66-mode span{font-size:var(--text-xs);color:var(--muted);margin-top:5px;line-height:1.35}
      .sn66-panel{padding:16px;margin-top:12px}.sn66-panel h2{font-size:var(--text-xl);margin:0 0 5px}.sn66-panel>p{margin:0 0 14px;color:var(--muted);font-size:var(--text-sm);line-height:1.45}
      .sn66-tools{display:grid;grid-template-columns:1fr 132px 150px;gap:8px;margin-bottom:10px}.sn66-search{display:flex;align-items:center;gap:8px;border:1px solid var(--line);border-radius:13px;padding:0 11px;background:var(--surface)}.sn66-search input,.sn66-tools select{width:100%;height:42px;border:0;background:transparent;color:var(--text);outline:0;font:inherit;font-size:var(--text-base);-webkit-text-size-adjust:100%}.sn66-tools select{border:1px solid var(--line);border-radius:13px;padding:0 9px;background:var(--surface)}
      .sn66-selected-list{display:grid;gap:7px;margin:12px 0}.sn66-selected-row{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:center;border:1px solid var(--line);border-radius:14px;padding:10px 11px;background:var(--surface)}.sn66-selected-row.editing{border-color:#9FC3FF;background:#F8FBFF}.sn66-selected-main{min-width:0;border:0;background:transparent;color:var(--text);padding:0;text-align:left;cursor:pointer}.sn66-selected-main strong,.sn66-selected-main small,.sn66-selected-main em{display:block}.sn66-selected-main strong{font-size:var(--text-sm)}.sn66-selected-main small{font-size:var(--text-xs);color:var(--muted);margin-top:3px}.sn66-selected-main em{font-style:normal;font-size:var(--text-xs);color:#2F6DF6;font-weight:850;margin-top:5px}.sn66-order{display:flex;gap:5px}.sn66-order button{width:31px;height:31px;border-radius:9px;border:1px solid var(--line);background:#F7F9FB;color:#64748B;display:grid;place-items:center}.sn66-order button:disabled{opacity:.3}
      .sn66-rx-editor{grid-column:1/-1;display:grid;grid-template-columns:1fr 1fr auto;gap:9px;align-items:end;padding:11px;margin-top:2px;border-radius:12px;border:1px solid #D7E4F7;background:#F3F8FF}.sn66-rx-field{display:grid;gap:5px;font-size:var(--text-xs);font-weight:850;text-transform:uppercase;letter-spacing:.04em;color:#667085}.sn66-stepper{display:grid;grid-template-columns:34px minmax(42px,1fr) 34px;align-items:center;overflow:hidden;border:1px solid var(--line);border-radius:10px;background:var(--surface)}.sn66-stepper button{height:36px;border:0;background:transparent;color:#2F6DF6;display:grid;place-items:center}.sn66-stepper input{width:100%;height:36px;border:0;border-left:1px solid var(--line);border-right:1px solid var(--line);background:transparent;color:var(--text);text-align:center;font:inherit;font-size:var(--text-sm);font-weight:850;outline:0;-moz-appearance:textfield}.sn66-stepper input::-webkit-outer-spin-button,.sn66-stepper input::-webkit-inner-spin-button{-webkit-appearance:none;margin:0}.sn66-rx-done{height:38px;border:0;border-radius:10px;padding:0 14px;background:#2F6DF6;color:#fff;font-size:var(--text-xs);font-weight:850}
      .sn66-results{display:grid;gap:6px;max-height:330px;overflow:auto}.sn66-ex-row{display:grid;grid-template-columns:1fr auto;gap:10px;align-items:center;padding:9px 2px;border-bottom:1px solid var(--line)}.sn66-ex-row strong,.sn66-ex-row small{display:block}.sn66-ex-row strong{font-size:var(--text-sm)}.sn66-ex-row small{font-size:var(--text-xs);color:var(--muted);margin-top:3px}.sn66-add{width:34px;height:34px;border-radius:10px;border:1px solid #D5E3FA;background:#F4F8FF;color:#2F6DF6;display:grid;place-items:center}.sn66-add.added{background:#EEF7D9;border-color:#D7E9AD;color:#6E981C}
      .sn66-existing{display:grid;gap:9px}.sn66-existing-row{display:grid;grid-template-columns:40px 1fr auto;gap:11px;align-items:center;border:1px solid var(--line);border-radius:15px;background:var(--surface);padding:12px;text-align:left;color:var(--text)}.sn66-existing-icon{width:38px;height:38px;border-radius:12px;background:#F2F6FF;color:#2F6DF6;display:grid;place-items:center}.sn66-existing-row strong,.sn66-existing-row small{display:block}.sn66-existing-row strong{font-size:var(--text-sm)}.sn66-existing-row small{font-size:var(--text-xs);color:var(--muted);margin-top:3px}.sn66-existing-row b{font-size:var(--text-xs);color:#2F6DF6}
      .sn66-question{margin-top:15px}.sn66-question>strong{display:block;font-size:var(--text-sm);margin-bottom:8px}.sn66-options{display:flex;flex-wrap:wrap;gap:7px}.sn66-option{border:1px solid var(--line);background:var(--surface);color:var(--text);border-radius:999px;padding:8px 11px;font-size:var(--text-xs);font-weight:700}.sn66-option.active{border-color:#AFCBFF;background:#EEF5FF;color:#245AA8}.sn66-generate{width:100%;margin-top:17px;border:0;border-radius:15px;background:#2F6DF6;color:#fff;padding:14px 16px;font-size:var(--text-sm);font-weight:800}.sn66-preview{margin-top:14px;border-top:1px solid var(--line);padding-top:14px}.sn66-preview-head{display:flex;justify-content:space-between;align-items:center;gap:10px;margin-bottom:9px}.sn66-preview-head h3{font-size:var(--text-base);margin:0}.sn66-verified{font-size:var(--text-xs);font-weight:800;color:#6C981B;background:#F1F8DD;border-radius:999px;padding:6px 8px}.sn66-preview-list{display:grid;gap:7px}.sn66-preview-row{display:grid;grid-template-columns:28px 1fr auto;align-items:center;gap:9px;border:1px solid var(--line);border-radius:13px;padding:9px 10px}.sn66-preview-num{width:26px;height:26px;border-radius:9px;background:#F3F6FA;display:grid;place-items:center;font-size:var(--text-xs);font-weight:800}.sn66-preview-row strong,.sn66-preview-row small{display:block}.sn66-preview-row strong{font-size:var(--text-xs)}.sn66-preview-row small{font-size:var(--text-xs);color:var(--muted);margin-top:2px}.sn66-preview-row b{font-size:var(--text-xs);color:#6C981B}.sn66-preview-actions{display:grid;grid-template-columns:1fr 1.6fr;gap:8px;margin-top:10px}.sn66-secondary,.sn66-start{border-radius:13px;padding:12px 13px;font-size:var(--text-sm);font-weight:800}.sn66-secondary{border:1px solid var(--line);background:var(--surface);color:var(--text);display:flex;justify-content:center;align-items:center;gap:6px}.sn66-start{border:0;background:#FF5A57;color:white}.sn66-start:disabled{opacity:.4}
      .sn66-empty{padding:22px 12px;text-align:center;color:var(--muted);font-size:var(--text-sm)}.sn66-save-card{margin-top:14px;padding:16px}.sn66-save-card h3{font-size:var(--text-lg);margin:0 0 5px}.sn66-save-card p{font-size:var(--text-xs);color:var(--muted);margin:0 0 12px}.sn66-save-actions{display:grid;grid-template-columns:1.4fr 1fr;gap:8px}.sn66-save-actions button{border-radius:13px;padding:11px 12px;font-size:var(--text-xs);font-weight:800}.sn66-save-primary{border:0;background:#2F6DF6;color:#fff}.sn66-save-skip{border:1px solid var(--line);background:var(--surface);color:var(--text)}
  ...
  function renderBuildResults(filtered = filteredBuildExercises()) {
    return filtered.slice(0,24).map(ex => {
      const id = exerciseId(ex);
  ...
  function renderSurprise() {
    ...
    return `<section class="card sn66-panel"><h2>Quick pick</h2><div class="sn66-question"><strong>Time</strong>${optionButtons(['15','30','45','60+'],qw.surprise.time,'time')}</div><div class="sn66-question"><strong>Focus</strong>${optionButtons(['Full body','Upper body','Lower body','Push','Pull','Legs','Surprise me'],qw.surprise.focus,'focus')}</div><div class="sn66-question"><strong>Equipment</strong>${optionButtons(['Full gym','Machines','Dumbbells','Bodyweight'],qw.surprise.equipment,'equipment')}</div><button class="sn66-generate" id="sn66Generate">${generated.length?'Regenerate':'Generate workout'}</button>${generated.length?`<div class="sn66-preview"><div class="sn66-preview-head"><h3>${esc(qw.surprise.actualFocus)} Workout</h3></div><div class="sn66-preview-list">${generated.map((ex,i)=>`<div class="sn66-preview-row"><span class="sn66-preview-num">${i+1}</span><div><strong>${esc(ex.name)}</strong><small>${esc(ex.muscle)} • ${ex.sets} sets</small></div></div>`).join('')}</div><div class="sn66-preview-actions"><button class="sn66-secondary" id="sn66Shuffle">${icon('refresh',15)} Shuffle</button><button class="sn66-start" id="sn66StartSurprise">Start workout</button></div></div>`:`<div class="sn66-empty" id="sn66SurpriseEmpty"></div>`}</section>`;
  }

  function renderQuickWorkout() {
    installStyles();
    app.innerHTML = `<section class="sn66-page"><div class="sn66-top"><button class="sn66-back" id="sn66Back" aria-label="Back">${icon('arrowLeft',21,2.3)}</button><div><h1>Start Workout</h1></div></div><div class="sn66-modes"><button class="sn66-mode ${qw.mode==='build'?'active':''}" data-mode="build"><span class="sn66-mode-icon">${icon('plus',22)}</span><strong>Create</strong></button><button class="sn66-mode ${qw.mode==='existing'?'active':''}" data-mode="existing"><span class="sn66-mode-icon">${icon('play',22)}</span><strong>Saved</strong></button><button class="sn66-mode ${qw.mode==='surprise'?'active':''}" data-mode="surprise"><span class="sn66-mode-icon">${icon('sparkles',22)}</span><strong>Quick pick</strong></button></div>${qw.mode==='build'?renderBuild():qw.mode==='existing'?renderExisting():qw.mode==='surprise'?renderSurprise():''}</section>`;
